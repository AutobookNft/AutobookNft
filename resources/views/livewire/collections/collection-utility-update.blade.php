<x-sidebar wichsidebar='collection-utility-update'>
    ...
    <x-slot:head>
        <x-sidebarhead
            ...
            type=""
            pagename="{{ 'Collection utility edit' }}" />
    </x-slot:head>
            ...
            <form x-data="{ isDisabled: true }"> @csrf
                ...
                <div class="grid grid-cols-3 mb-3">
                    ...
                    <div class="col-span-3 auto justify-center">
                        <p class='font-semibold text-xl'>
                            {{ __('Enter the data of the utility or product you want to combine with your collection') }}
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-2 mb-3">
                    ...
                    <div class="col-span-1">
                        <x-jet-label for="util_code" value="{{ __('Code') }}" />
                        <x-jet-input @keydown="isDisabled=false" id="util_code" type="text" class="block w-full mt-1" wire:model.defer="util_code" />
                        <x-jet-input-error for="util_code" class="mt-1" />
                    </div>

                    <div class="col-span-1">
                        <x-jet-label for="util_date" value="{{ __('Date') }}" />
                        <x-jet-input @keydown="isDisabled=false" id="util_date" type="date" class="block w-full mt-1" wire:model.defer="util_date" />
                        <x-jet-input-error for="util_date" class="mt-1" />
                    </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <x-jet-input-error for="util_spec_1" class="mt-1" />
                </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <x-jet-input-error for="util_spec_2" class="mt-1" />
                </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <x-jet-input-error for="util_spec_3" class="mt-1" />
                </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <x-jet-input-error for="util_spec_4" class="mt-1" />
                </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <x-jet-input-error for="util_spec_5" class="mt-1" />
                </div>

                <div class="w-full mb-3">
                    <div class="flex item-center sm:col-span-4">
                        <div class="w-3/6 pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input @keydown="isDisabled=false" id="joint-1" type="radio" name="util_joint" wire:model.defer="util_joint" value='1' class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500
                        ...
                        <div class="w-3/6 pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input @keydown="isDisabled=false" checked id="joint-2" type="radio" name="util_joint" wire:model.defer="util_joint" value='0'
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500
                                dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700
                                dark:border-gray-600">
                            <label for="bordered-radio-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-green-900 dark:text-green-600">{{__('Notjoint') }}</label>
                        </div>
                    </div>
                ...
                <div
                    class="mt-8 flex items-center justify-end px-4 py-3 bg-gray-50 text-right sm:px-6 shadow sm:rounded-bl-md sm:rounded-br-md">

                    <x-jet-secondary-button wire:click="openModal" class='mr-3 mb-1'>
                        {{ __('Add attachment files') }}
                    </x-jet-secondary-button>

                    <div class="mb-1 flex items-center justify-end bg-white">
