<div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="fixed-10 inset-0 transition-opacity">
        ...
        overflow-hidden shadow-xl transform sm:align-middle w-1/3" 
                    role="dialog" 
                    aria-modal="true" 
            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            <label for="title" class="block text-gray-700 text-base font-bold mb-2">Title:</label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="flex">
                                    ...
                                    {{-- <div class="px-2" wire:loading wire:target="photos">Uploading</div> --}}
