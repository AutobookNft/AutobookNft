        ...
        <div class="mt-10 sm:mt-0">
            {{-- <x-jet-action-section>
                ...
                {{-- <x-slot name="content"> --}}
                    ...
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Active members of this collection.') }}
                        </div>
                    </div>
                        ...
                        @foreach ($team->users->sortBy('name') as $user)
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    @if($user->profile_photo_path != '' && $user->profile_photo_path != 0 && $user->profile_photo_path != null)
                                        <img class="w-8 h-8 rounded-full" src="{{ $user->profile_photo_path }}">
                                    @endif
                                    <div class="ml-4">{{ $user->first_name }}</div>
