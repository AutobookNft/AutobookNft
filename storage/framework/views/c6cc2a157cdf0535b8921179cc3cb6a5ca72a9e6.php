            ...
            <form wire:submit.prevent="upload()" wire:loading.attr="disabled">
                ...
                <div x-data="{ fileName: null, filePreview: null }" class="grid grid-cols-1 mb-4 bg-gray-500">
                    ...
                    <p class="counded-t-b p-4 text-lg bg-gray-300 text-gray-800">
                        <?php echo e(__('Ti consiglio di non fare un upload di molti file di grandi dimensioni, il sistema potrebbe non consentirtelo
                    ...
                    <p class="counded-t-b p-4 text-lg bg-gray-300 text-red-800">
                        <?php echo e(__('dimensione massima di una singolo file: 100mb')); ?>
                    ...
                    <div x-data="{ isUploading: false, progress: 0 }"
                        ...
                        <div class="grid grid-cols-6">
                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($file->getClientOriginalExtension()!='tif'): ?>

                                    <div class = "max-w-24 max-h-24 rounded-full">
                                        <img src="<?php echo e($file->temporaryUrl()); ?>" class="max-w-20 max-h-20 rounded-full">
                                    </div>
...
<?php /**PATH /var/www/natan_blog/resources/views/livewire/collections/create.blade.php ENDPATH**/ ?>