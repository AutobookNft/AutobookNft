<div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        overflow-hidden shadow-xl transform sm:align-middle w-96"
            ...
            <form wire:submit.prevent="externalTransfer(<?php echo e($itemId); ?>)" wire:loading.attr="disabled">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.validation-errors','data' => ['class' => 'mb-4 text-lg bg-black']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-4 text-lg bg-black']); ?>
...
<?php endif; ?>
                    ...
                    <p class ="counded-t-b p-4 text-lg bg-gray-300 text-red-800">
                        <?php echo e(__("Scrivi la mail del compratore")); ?>
...
<?php /**PATH /var/www/natan_blog/resources/views/livewire/collections/item-include/external-transfer.blade.php ENDPATH**/ ?>