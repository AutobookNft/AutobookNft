...
<?php $component = App\View\Components\Sidebar::resolve(['wichsidebar' => 'item-zoom'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sidebarhead','data' => ['image' => ''.e($teamItem->thumbnail).'','name' => ''.e($collectionname).'','type' => ''.e($teamItem->type).'','pagename' => ''.e('Edit item').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['image' => ''.e($teamItem->thumbnail).'','name' => ''.e($collectionname).'','type' => ''.e($teamItem->type).'','pagename' => ''.e('Edit item').'']); ?>
...
<?php endif; ?>
     ...
     <?php $__env->slot('itemedit', null, []); ?> 
       <a href="<?php echo e(url('/dashboard/collection/items_edit/'. $itemId)); ?>">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sidebar-leftarrow','data' => ['item' => ''.e(__('Back to item-edit')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['item' => ''.e(__('Back to item-edit')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
     ...
     <?php $__env->slot('items', null, ['class' => 'font-bold']); ?> 
        ...
        <div class="absolute top-40 xs:left-60 xl:left-80 
            ...
            <img src="<?php echo e($teamItem->hash_file); ?>" class="w-full h-full rounded">  
...
<?php endif; ?>
<?php /**PATH /var/www/natan_blog/resources/views/livewire/collections/item-zoom.blade.php ENDPATH**/ ?>