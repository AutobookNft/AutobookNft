<div class= 'flex justify-center'>
    <?php if($paginator->hasPages()): ?>
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden flex flex-col  sm:flex sm:items-center sm:justify-between">
...
<?php /**PATH /var/www/natan_blog/resources/views/vendor/livewire/tailwind.blade.php ENDPATH**/ ?>