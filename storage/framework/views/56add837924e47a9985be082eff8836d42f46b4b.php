    ...
    <?php if($price): ?>
        <div class ='mr-2 mb-2 auto text-right'>
            <span class='text-md font-semibold tracking-tight text-gray-900 bg-gray-200 rounded p-2'>
                <?php echo e(__('Price: ') .  $price . __(' Algo')); ?>
    ...
    <?php if($drop!='empty'): ?>
        <?php if(!$item->drop_id): ?>
            <div class ='mr-2 mb-2 auto text-right'>
                ...
                <input id='drop' type="checkbox" value="<?php echo e($item->id); ?>" wire:model="selectedItems">
            </div>
        <?php endif; ?>
        <?php if($item['drop_id']): ?>
            <div class ='mr-2 mb-2 auto text-right'>
                <span class='text-md font-semibold tracking-tight text-gray-900 bg-gray-200 rounded p-2'>
                    <?php echo e(__('Drop title: ') . $dropTitle); ?>
...
<?php /**PATH /var/www/natan_blog/resources/views/livewire/collections/item-include/onlyread.blade.php ENDPATH**/ ?>