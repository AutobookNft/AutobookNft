...
} elseif ($_instance->childHasBeenRendered('5WnVdnp')) {
    $componentId = $_instance->getRenderedChildComponentId('5WnVdnp');
    $componentTag = $_instance->getRenderedChildComponentTagName('5WnVdnp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5WnVdnp');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('5WnVdnp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/2023_04_01/natan_blog/resources/views/layouts/app.blade.php ENDPATH**/ ?>