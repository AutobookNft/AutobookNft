<div>
    ...
    <?php if(!$dropSelect): ?>
        <?php ($drops=$drop); ?>      
        <?php echo $__env->make('livewire.drop-crud', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <div
...
<?php /**PATH /var/www/natan_blog/resources/views/livewire/item-drop.blade.php ENDPATH**/ ?>