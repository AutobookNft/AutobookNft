                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <?php if(Route::has('login')): ?>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-xl text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                                    <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="text-xl text-gray-700 dark:text-gray-500 underline">Log in</a>

                                    <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="ml-4 text-xl text-gray-700 dark:text-gray-500 underline">Register</a>
                                    <?php endif; ?>
                                    <?php endif; ?>
...
<?php /**PATH /var/www/2023_04_01/natan_blog/resources/views/welcome.blade.php ENDPATH**/ ?>