...
<div x-data="{ shown: false, timeout: null }"
    x-init="window.livewire.find('<?php echo e($_instance->id); ?>').on('<?php echo e($on); ?>', () => { clearTimeout(timeout); shown = true; timeout = setTimeout(() => { shown = false }, 4000);  })"
...
<?php /**PATH /var/www/2023_04_01/natan_blog/resources/views/vendor/jetstream/components/action-message.blade.php ENDPATH**/ ?>